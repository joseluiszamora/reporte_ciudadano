...
El repositorio contiene documentación en `docs/` y un prototipo Flutter para Android hasta la octava entrega: tema, navegación, lista/detalle públicos, acceso simulado, reportes y borradores, moderación con versiones, ocultamiento, duplicados, confirmaciones únicas, aportes revisados, seguimiento, avisos simulados, gestiones revisadas, solución/verificación/reapertura, lectura pública compartida, retiro de autoría, denuncia de contenido y exploración con mapa esquemático y filtros. La moderación editorial y el ocultamiento operan sobre reportes creados en el dispositivo; el catálogo es de lectura y admite participación, gestiones, decisiones de seguimiento y recepción/revisión de denuncias sin ocultarlo. Consulta `README.md` y `docs/08_entrega_mapa_filtros.md` para el alcance, ejecución y comprobaciones actuales; las entregas anteriores se conservan en los documentos 03–07. No hay infraestructura ni integraciones externas reales; no describas componentes planeados como existentes.
